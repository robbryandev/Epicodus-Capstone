...
export default function Nav() {
    ...
    return (
        <div className="flex justify-center md:justify-start absolute bottom-0 left-0 md:bottom-auto md:top-0 w-full h-14 md:pl-20 bg-zinc-800 text-white font-semibold text-2xl md:text-l drop-shadow-lg">
